...
#ifndef SRC_GAME_ENGINE_VIEWS_MAP_VIEW_H
#define SRC_GAME_ENGINE_VIEWS_MAP_VIEW_H
...
class MapView : public sf::Drawable, public sf::Transformable {
 public:
  ...
  void setMap(FieldArray field_array, sf::Vector2u field_offset,
...
#endif  // SRC_GAME_ENGINE_VIEWS_MAP_VIEW_H